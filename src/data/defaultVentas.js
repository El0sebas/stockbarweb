...
export const defaultVentas = [
  {
    ...
    productos: [
      { nombre: 'Tequila Don Julio Reposado', cantidad: 1, precio: 240000, lote: 'LT-001' },
      { nombre: 'Cerveza Club Colombia Dorada', cantidad: 4, precio: 8000, lote: 'CR-110' }
    ],
    total: 272000,
    estado: 'Completado'
  },
  {
    ...
    productos: [
      { nombre: 'Aguardiente Antioqueño 750ml', cantidad: 2, precio: 65000, lote: 'AG-208' }
    ],
    total: 130000,
    estado: 'Pendiente'
  }
